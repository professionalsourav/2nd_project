...
<jsp:include page="header.jsp" />
	...
	<tr><td>Flight Number:<% out.print(" "+flyNo) ;%></td>
	<td>Travel:<% out.print(" "+ f2.getSource()+ " to " + f2.getDestination()) ;%></tr>
	<tr><td>Date:<% out.print(" "+f2.getSchedule()) ;%></td><td>Time:<% out.print(" "+f2.getDeparture_time());%></td></tr>
	<tr><td>Travel duration:<% out.print(" "+f2.getDuration()+" hrs") ;%></td>
	<tr><td>Ticket Price :<% out.print(" "+f2.getPrice()+" Rs") ;%></td></tr>
	...
	<tr><td>Total Price:<% out.print(" "+f2.getPrice()*noOfPerson+" Rs");%></td></tr>
	</table>
 <div class="content">
